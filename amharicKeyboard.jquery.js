...
(function ($) {
    ...
    $.fn.amharicKeyboard = function (options) {
        ...
        if (this.length > 1) {
            this.each(function () { $(this).amharicKeyboard(options) });
            return this;
        }
        ...
        this.changeMode = function (selectedMode) {
            self.options.mode = selectedMode;
        }
        ...
        var appendWithReplace = function (hohe) {
            insertTextAtCursor(self[0], hohe, true);
        }
        this.appendHohe = function (hohe) {
            insertTextAtCursor(self[0], hohe, false);
        }

        var appendWithSadisCheck = function (hohe) {
            var isSadis = self.isLastCharSadis();
        ...
        this.replaceLastCharacter = function (alphabet) {
